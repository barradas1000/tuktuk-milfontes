      ...
      <CardContent className="space-y-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="numberOfPeople" className="text-blue-900 font-semibold flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="time" className="text-blue-900 font-semibold flex items-center gap-2">
