                ...
                <motion.div
                  ...
                  animate={{
                    ...
                    zIndex: isActive(index)
                      ? 40
                      : translatedTestimonials.length + 2 - index,
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            <h3 className="text-2xl font-bold text-blue-900 dark:text-white">
              {translatedTestimonials[active].name}
            </h3>
...
>>>>>>> c8a33077bab7f709cdfa791e69ccd28f2ae30363
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 hover:bg-amber-200 transition-colors duration-300 dark:bg-neutral-800"
            >
              <ArrowLeft className="h-5 w-5 text-blue-900 transition-transform duration-300 group-hover/button:rotate-12 dark:text-neutral-400" />
            </button>
            <button
              onClick={handleNext}
              className="group/button flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 hover:bg-amber-200 transition-colors duration-300 dark:bg-neutral-800"
            >
              <ArrowRight className="h-5 w-5 text-blue-900 transition-transform duration-300 group-hover/button:-rotate-12 dark:text-neutral-400" />
            </button>
          </div>
        </div>
      </div>
